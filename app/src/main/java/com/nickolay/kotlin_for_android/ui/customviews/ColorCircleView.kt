package com.nickolay.kotlin_for_android.ui.customviews
...
class ColorCircleView @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0): View(context, attrs, defStyleAttr) {
    ...
    @ColorRes
    var strokeColorRes: Int = R.color.color_circle_stroke
        set(value) {
            field = value
    ...
    @Dimension(unit = PX)
    var strokeWidth = dip(defStrokeWidthDp)
        set(value) {
            field = value
    ...
    init {
        ...
        strokeColorRes = a.getResourceId(R.styleable.ColorCircleView_strokeColor, R.color.color_circle_stroke)
        a.recycle()
    }
